...
export type CreateCaseMutationVariables = Exact<{
  ...
  status: Scalars['Picklist']['input'];
  priority: Scalars['Picklist']['input'];
}>;


export type CreateCaseMutation = { uiapi: { CaseCreate?: { Record?: { Id: string, CaseNumber?: { value?: string | null } | null, Subject?: { value?: string | null } | null, Status?: { value?: string | null } | null, Priority?: { value?: string | null } | null, CreatedDate?: { value?: string | null } | null } | null } | null } };
...
export type DeleteCaseMutation = { uiapi: { CaseDelete?: { Id?: string | null } | null } };
...
export type UpdateCaseMutation = { uiapi: { CaseUpdate?: { success?: boolean | null, Record?: { Id: string, CaseNumber?: { value?: string | null } | null, Status?: { value?: string | null } | null } | null } | null } };

export type GetCasesQueryVariables = Exact<{ [key: string]: never; }>;


export type GetCasesQuery = { uiapi: { query: { Case?: { totalCount: number, edges?: Array<{ node?: { Id: string, CaseNumber?: { value?: string | null } | null, Subject?: { value?: string | null } | null, Status?: { value?: string | null } | null, Priority?: { value?: string | null } | null, CreatedDate?: { value?: string | null } | null } | null } | null> | null } | null } } };
